...
type NikeProductSearchResponse struct {
	TotalResources int `json:"totalResources"`
	Objects        []struct {
		ProductID         string      `json:"productId"`
		ProductGroupID    string      `json:"productGroupId"`
		...
		ProductLine1      string      `json:"productLine1"`
		ProductLine2      string      `json:"productLine2"`
		Slug              string      `json:"slug"`
		ColorCode         string      `json:"colorCode"`
		Color             string      `json:"color"`
		NikeType          string      `json:"nikeType"`
		NikeID            bool        `json:"nikeId"`
		...
		Prices            struct {
			...
			EmployeeDiscount bool   `json:"employeeDiscount"`
		} `json:"prices"`
		URL          string `json:"url"`
